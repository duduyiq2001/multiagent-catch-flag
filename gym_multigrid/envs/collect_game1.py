...
class CollectGameEnv1(MultiGridEnv):
    """
...
class CollectGame4HEnv10x10N21(CollectGameEnv1):
    def __init__(self):
        ...
        balls_reward=[1,1,1],
        zero_sum=True)
class CollectGame1fullobs(CollectGameEnv1):
    def __init__(self):
        super().__init__(size=10,
        num_balls=[3],
        agents_index = [1,2,2],
...
class CollectGame15by5(CollectGameEnv1):
    def __init__(self):
