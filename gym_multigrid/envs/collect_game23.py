...
class CollectGameEnv23(MultiGridEnv):
    """
...
class CollectGame234HEnv10x10N2(CollectGameEnv23):
    def __init__(self):
        ...
        balls_reward=[1,1,1],
        zero_sum=True)
class CollectGame23fullobs(CollectGameEnv23):
    def __init__(self):
        super().__init__(size=10,
        num_balls=[3],
        agents_index = [1,2,2],
...
class CollectGame235by5(CollectGameEnv23):
    def __init__(self):
